...
export const LoginPage: React.FC<LoginPageProps> = ({
  ...
  const handleEmployeePinLogin = (e?: React.FormEvent) => {
    ...
    // Verify PIN against emp.pinCode or demo PINs
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          {loginMode === 'EMPLOYEE' && (
            <div className="bg-slate-50/80 dark:bg-[#0b1528]/90 border border-slate-200/90 dark:border-[#1a2c52] rounded-3xl p-6 sm:p-8 shadow-xl space-y-6 backdrop-blur-sm">
              ...
              <div className="flex bg-slate-200/60 dark:bg-[#060c18] p-1 rounded-xl gap-1 border border-slate-300/50 dark:border-[#142342]">
                <button
                  type="button"
                  ...
                  className={`flex-1 py-1.5 text-[11px] font-bold rounded-lg transition flex items-center justify-center gap-1.5 ${
                    empAuthMethod === 'PIN'
                      ? 'bg-white dark:bg-[#101d36] text-blue-600 dark:text-cyan-300 shadow-xs'
                  ...
                  <div className="space-y-2 text-center">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-slate-500 dark:text-slate-400">
                        Demo PIN: <code className="text-blue-700 dark:text-cyan-300 bg-blue-50 dark:bg-cyan-950/60 px-1 py-0.5 rounded font-mono font-bold">123456</code>
                      </span>
                    </div>

                    <div className="flex items-center justify-center gap-2.5 py-3 bg-white dark:bg-[#070e1c] border border-slate-200 dark:border-[#1e325c] rounded-2xl shadow-inner">
                      {[0, 1, 2, 3, 4, 5].map((idx) => {
                          ...
                          <div
                            ...
                            className={`w-8 h-10 rounded-xl flex items-center justify-center text-lg font-mono font-extrabold transition-all duration-150 ${
                              isFilled
                                ...
                                : 'bg-slate-100 dark:bg-[#101d36] text-slate-400 border border-slate-200 dark:border-[#1a2c52]'
                            }`}
                          >
                            {isFilled ? '●' : '○'}
                          </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 max-w-xs mx-auto">
                    {['1', '2', '3', '4', '5', '6', '7', '8', '9'].map((num) => (
                      <button
                        ...
                        className="py-3 bg-white dark:bg-[#0e1a30] hover:bg-blue-50 dark:hover:bg-[#16294d] active:scale-95 text-slate-900 dark:text-white font-extrabold text-base rounded-2xl border border-slate-200/90 dark:border-[#1a2d54] shadow-2xs transition flex items-center justify-center"
                      >
                        {num}
                      </button>
                    ))}
                    <button
                      ...
                      className="py-3 bg-slate-200/60 dark:bg-[#071022] hover:bg-slate-300 dark:hover:bg-[#101e38] text-slate-600 dark:text-slate-400 font-extrabold text-xs rounded-2xl border border-slate-200 dark:border-[#1a2d54] transition flex items-center justify-center"
                    >
                      Clear
                    </button>
                    <button
